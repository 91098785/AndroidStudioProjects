...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    ImageView imageView_division;
    ImageView imageView_multiplication;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView_division = (ImageView)findViewById(R.id.imageViewdiv);
        imageView_multiplication = (ImageView)findViewById(R.id.imageViewmul);
        ...
        imageView_clear = (ImageView)findViewById(R.id.imageViewclear);
        ...
        imageView_division.setOnClickListener(this);
        imageView_multiplication.setOnClickListener(this);
    ...
    public void onClick(View view)
    {
        ...
        else if (view.getId() == R.id.imageViewminus)
        {
            ...
            imageView_division.setBackgroundColor(0);
            imageView_multiplication.setBackgroundColor(0);
            operator = 1;
        ...
        else  if  (view.getId() == R.id.imageViewdiv)
        {
            imageView_division.setBackgroundColor(0xff00ffff);
            imageView_minus.setBackgroundColor(0);
            imageView_plus.setBackgroundColor(0);
            imageView_multiplication.setBackgroundColor(0);
        ...
        else  if  (view.getId() == R.id.imageViewmul)
        {
            imageView_multiplication.setBackgroundColor(0xff00ffff);
            imageView_plus.setBackgroundColor(0);
            imageView_minus.setBackgroundColor(0);
            imageView_division.setBackgroundColor(0);
        ...
        else  if  (view.getId() == R.id.imageViewequals)
        {
            ...
            if (solved == num1 / 0)
            {
                textViewbottom.setText("ERROR");
                textViewbottom.setBackgroundColor(0xff00ffff);
